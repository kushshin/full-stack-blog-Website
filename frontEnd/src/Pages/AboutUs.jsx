    ...
    <div>
      <div className=' '>
        ...
        <div className='md:flex  items-center m-8'>
          ...
          <p className='m-8 text-[#bbbb8e]'>Welcome to <span className='text-[24px] text-[#747431]'>S</span>tack<span className='text-[24px] text-[#747431]'>B</span>its, a space where ideas, technology, and creativity come together. Our mission is simple: to share knowledge, inspire innovation, and create a community of curious minds who love exploring the digital world.
